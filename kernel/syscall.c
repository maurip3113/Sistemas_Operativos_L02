...
extern uint64 sys_count_value(void);
extern uint64 sys_count_inc(void);
extern uint64 sys_count_dec(void);
...
[SYS_count_value]   sys_count_value,
[SYS_count_inc]   sys_count_inc,
[SYS_count_dec]   sys_count_dec,
